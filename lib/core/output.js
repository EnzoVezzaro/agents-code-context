/**
 * Deterministic output: the JSON envelope (per the JSON schema spec)
...
/** Build the standard envelope (per the JSON schema spec). */
...
/** Error envelope (per the JSON schema spec). */
