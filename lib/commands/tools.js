 ...
 * capabilities (per the tooling spec). V1 exposes the capability listing;
 * execution
...
module.exports = {
  ...
  run(argv, ctx) {
    ...
    const result = {
      ...
      detected,
      plugins,
      note: 'V1 lists capabilities only. acc tool / acc shell execution is documented as future work (see the tooling spec).',
    };
