 ...
 *
 * AGENTS.md templates use the standard Markdown sections from
 * docs/09-authoring-guide.md — no ACC-specific schema.
 */
'use strict';
...
# still works. See docs/02-repository-structure.md.
schema_version: 1
`;
}

/** Canonical AGENTS.md template (docs/09 §4). */
