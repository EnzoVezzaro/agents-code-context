...
See [09 — AGENTS.md Authoring Guide](./authoring-guide.md).
...
Plain Markdown. Human-readable. No schema. ACC treats unstructured prose as memory; structured memory uses well-known headings as keys (see [08 — Memory Semantics](./memory-semantics.md)).
