...
4. **Provenance Everywhere.** No architectural fact appears without a `provenance` object (see [03 — Epistemology](./epistemology.md#3-provenance-contract)).
...
| `diagnostics` | yes | Array of diagnostics (see [06](./diagnostic-codes.md#15-json-shape)). Empty if none. |
